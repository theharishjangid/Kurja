...
const Project = async ({ params }) => {
	...
	return (
		<main className="container mx-auto">
			<Link
				href="/portfolio"
				className="mt-6 mx-2 group inline-flex text-sm sm:text-base items-center hover:text-red-600 text-transparent bg-clip-text bg-gradient-to-r from-green-700 via-green-600 to-lime-500">
