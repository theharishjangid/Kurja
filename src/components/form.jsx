...
export default function ContactForm() {
  ...
  return (
    (<div
      className="rounded-none sm:rounded-xl w-full sm:w-auto p-4 md:p-8 shadow-input bg-white">
      ...
      * Schedule an appointment to experience our focused and personalized care.
      </p>
      <form onSubmit={handleSubmit}>
        <div
          ...
          <LabelInputContainer>
            ...
            <Input id="firstname" placeholder="Harish" type="text" />
          </LabelInputContainer>
          <LabelInputContainer>
        ...
        <LabelInputContainer className="mb-4">
          ...
          <Input id="phone" placeholder="1234567890" type="tel" pattern="[6789][0-9]{9}" />
        </LabelInputContainer>
