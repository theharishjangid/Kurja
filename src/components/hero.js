    ...
    return (
        <ImagesSlider
				...
				<motion.div
					...
					<Link href="/portfolio">
					<button className="px-4 py-2 backdrop-blur-sm border bg-red-amber/10 border-amber-500/20 text-white mx-auto text-center rounded-md relative mt-4">
						<span>Explore More →</span>
						<div className="absolute inset-x-0  h-px -bottom-px bg-gradient-to-r w-3/4 mx-auto from-transparent via-amber-700 to-transparent" />
					</button>
					</Link>
				</motion.div>
			</ImagesSlider>
