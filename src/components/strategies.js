			...
			<div className="mt-10 mx-4 grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 lg:gap-12">
				<div className="text-center space-y-4">
					...
					<p className="text-gray-500">
						Collaborating closely with you to understand your vision
						and crafting a design blueprint that captures your
				...
				<div className="text-center space-y-4">
					...
					<p className="text-gray-500 leading-relaxed">
						Bringing concepts to life with meticulous attention to
						detail, ensuring every element aligns with the
				...
				<div className="text-center space-y-4">
					...
					<p className="text-gray-500 leading-relaxed">
						...
						beauty and unparalleled sophistication tailored to your
						needs.
					</p>
				</div>
			</div>
